   ...
   document.body.addEventListener("input", function (e) {
      ...
      if ((targetElement.tagName === 'INPUT' || targetElement.tagName === 'TEXTAREA')) {
         if (targetElement.value.length > 0) {
            targetElement.classList.add('_fill');
            targetElement.parentElement.classList.add('_fill');
         }
         else {
            targetElement.classList.remove('_fill');
            targetElement.parentElement.classList.remove('_fill');
         }
      }
   });
